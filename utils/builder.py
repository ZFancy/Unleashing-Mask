...
class Builder(object):
    def __init__(self, conv_layer, bn_layer, linear_layer, first_layer=None):
        self.conv_layer = conv_layer
        self.bn_layer = bn_layer
        self.linear_layer = linear_layer
        self.first_layer = first_layer or conv_layer

    def conv(self, kernel_size, in_planes, out_planes, stride=1, first_layer=False, padding=0):
    ...
    def conv1x1(self, in_planes, out_planes, stride=1, first_layer=False,  padding=0):
        """1x1 convolution with padding"""
        c = self.conv(1, in_planes, out_planes, stride=stride, first_layer=first_layer, padding=padding)
        return c
    ...
    def linear(self, in_planes, num_classes):
        return self.linear_layer(in_planes, num_classes)
...
def get_builder():
    ...
    builder = Builder(conv_layer=conv_layer, bn_layer=bn_layer, first_layer=first_layer, linear_layer=linear_layer)
